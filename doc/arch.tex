\xname{arch}
\chapter{Architecture of Petablox}
\label{chap:arch}
...
well.) Petablox uses the \xlink{Soot}{http://sable.github.io/soot/} Java compiler
...
Petablox uses the \xlink{Javassist}{http://www.javassist.org/} Java bytecode
