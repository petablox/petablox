...
public class Program {
    ...
    /*
     *	Program Constructor for android 
     */
    private Program(boolean isAndroid){	
    	assert(isAndroid);
    	try {
			...
			options.append(" -soot-classpath "+System.getProperty("stamp.android.jar")+File.pathSeparator+System.getProperty("petablox.class.path"));
            ...
            Scene.v().loadBasicClasses();
			String mainClassName = System.getProperty("petablox.main.class");
    ...
    public static Program g() {
    	boolean isAndroid = Config.android;
        if (program == null){
        	if(isAndroid)
