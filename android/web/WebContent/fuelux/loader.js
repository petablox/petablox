...
define('fuelux/tree',['require','jquery'],function(require) {
	...
	var Tree = function (element, options) {
		...
		this.$element.on('click', '.tree-folder-icon', $.proxy( function(ev) { this.selectFolder( $(ev.currentTarget).parent()); }, this));
		this.$element.on('click', '.tree-folder-name', $.proxy( function(ev) { this.clickFolder( $(ev.currentTarget).parent()); }, this));
		this.render();
	};
	...
	Tree.prototype = {
		...
		selectFolder: function (el) {
			...
			if($el.find('.icon-plus-sign').length) {
