...
public class SourceMapGenerator {
	...
	public void visitInvokeExpression(int lineNum, String calleeChordSig, int calleeStartPos, int calleeEndPos, String expression,
			List<SimpleCodeStructure> arguments, List<String> argumentNames, List<String> argumentTypes,
			String tag, String specialReceiver) {
		
		this.writer.println("\t<" + tag + " line=\"" + lineNum + "\" chordsig=\"" + escapeXml(calleeChordSig) + "\""
