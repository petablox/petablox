...
public class Experiment implements StampOutputFile {
	 ...
	 * @see petablox.android.missingmodels.util.FileManager.StampFile#getName()
	 */
	@Override
	 ...
	 * @see petablox.android.missingmodels.util.FileManager.StampFile#getType()
	 */
	@Override
	 ...
	 * @see petablox.android.missingmodels.util.FileManager.StampOutputFile#getContent()
	 */
	@Override
