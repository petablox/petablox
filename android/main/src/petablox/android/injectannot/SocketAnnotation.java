...
/**
  * attach param values to socket.
  **/
public class SocketAnnotation extends AnnotationInjector.Visitor
{
    ...
    private void visitMethod(SootMethod method)
    {
        ...
        while(uit.hasNext()){
            ...
            if(stmt.containsInvokeExpr()){
                ...
                if (methodRefStr.contains("new Socket()")) {
                    ...
                    //System.out.println("Begin to query. socket......" + ie.getArg(0));
