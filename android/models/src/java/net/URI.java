class URI
{
	...
	@STAMP(flows={@Flow(from="scheme",to="this"),@Flow(from="schemeSpecificPart",to="this"),@Flow(from="fragment",to="this")})
	...
	@STAMP(flows={@Flow(from="scheme",to="this"),@Flow(from="host",to="this"),@Flow(from="path",to="this"),@Flow(from="fragment",to="this")})
	...
	@STAMP(flows={@Flow(from="scheme",to="this"),@Flow(from="authority",to="this"),@Flow(from="path",to="this"),@Flow(from="query",to="this"),@Flow(from="fragment",to="this")})
