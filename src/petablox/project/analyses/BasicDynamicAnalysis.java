 ...
 * {@link petablox.project.analyses.DynamicAnalysis}.
...
public class BasicDynamicAnalysis extends JavaAnalysis {
     ...
     * subclass of {@link petablox.runtime.TraceEventHandler}, then it is multi-JVM;
     ...
     * subclass of {@link petablox.instr.BasicInstrumentor}.
     */
     ...
     * {@link petablox.runtime.BasicEventHandler}.  Additionally, if the dynamic
     ...
     * which extends {@link petablox.runtime.TraceEventHandler}.
     */
