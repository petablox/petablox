 ...
 */
package petablox.analyses.escape.hybrid.path;
...
import petablox.analyses.dynamic.FldObj;
import petablox.analyses.escape.ThrEscException;
import petablox.analyses.escape.dynamic.DynamicThreadEscapeAnalysis;
import petablox.analyses.alloc.DomH;
import petablox.project.Petablox;
import petablox.project.OutDirUtils;
import petablox.project.ClassicProject;
import petablox.project.analyses.ProgramRel;
import petablox.util.IntArraySet;
...
public class ThreadEscapePathAnalysis extends DynamicThreadEscapeAnalysis {
    ...
    public void doneAllPasses() {
        ...
        for (int e = 0; e < domE.size(); e++) {
            if (accE[e]) {
                accErel.add(e);
                String estr = SootUtilities.toVerboseStr(domE.get(e));
