// SortedIntArraySet.java, created Wed Mar  5  0:26:26 2003 by joewhaley
 ...
 * @version $Id: SortedIntArraySet.java,v 1.2 2005/04/29 02:32:24 joewhaley Exp $
 */
public class SortedIntArraySet implements Cloneable, Serializable, RandomAccess {
     ...
     *            is negative
     */
    public SortedIntArraySet(int initialCapacity) {
        super();
    ...
    public SortedIntArraySet(SortedIntArraySet c) {
    ...
    public boolean addAll(SortedIntArraySet that) {
    ...
    public boolean equals(SortedIntArraySet that) {
    ...
    public Object clone() {
        try {
            SortedIntArraySet s = (SortedIntArraySet) super.clone();
