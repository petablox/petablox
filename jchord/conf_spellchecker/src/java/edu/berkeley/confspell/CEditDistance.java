...
/**
 * Wraps the edit distance calculation used for making spellcheck guesses. For
 * now, uses the Levenshtein distance calculation from StringUtils in the Apache
...
public class CEditDistance {
	 ...
	 * 
	 * String[] s1Words = splitIntoWords(s1); String[] s2Words =
	 * splitIntoWords(s2);
	 * 
	 * }
	 * 
	...
	// The code below is from the Apache Commons lang project.
	/*
