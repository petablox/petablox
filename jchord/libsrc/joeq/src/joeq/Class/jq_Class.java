...
public final class jq_Class extends jq_Reference implements jq_ClassFileConstants, CompilationConstants {
	...
	private static Comparator comparator = new Comparator() {
		public int compare(Object o1, Object o2) {
			jq_Member m1 = (jq_Member) o1;
			jq_Member m2 = (jq_Member) o2;
			String s1 = m1.getNameAndDesc().toString();
			String s2 = m2.getNameAndDesc().toString();
			return s1.compareTo(s2);
		}
	};
	private Object[] sortedMembers = null;
	public Object[] getSortedMembers() {
		if (sortedMembers == null) {
			sortedMembers = members.values().toArray();
			Arrays.sort(sortedMembers, comparator);
		}
   ...
   //// Available after resolving
	...
	public final boolean extendsClass(jq_Class k) {
        chkState(STATE_PREPARED);
		if (this == k)
			return true;
        if (super_class == null) 
			return false;
		return super_class.extendsClass(k);
	}
    ...
    throws ClassFormatError, UnsupportedClassVersionError, ClassCircularityError, NoClassDefFoundError {
        ...
        try {
            in = ((PrimordialClassLoader)class_loader).getClasspath().getClassFileStream(desc);
